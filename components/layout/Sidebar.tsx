  ...
  const getNavigationItems = (role: string) => {
    ...
    if (role === 'admin') {
      ...
      return [
        ...
        { name: 'Podcast Application', href: '/podcast-application', icon: 'MicrophoneIcon' },
      ];
    } else if (role === 'retailer') {
      return [
        ...commonItems,
        { name: 'Wishlist', href: '/retailer/wishlist', icon: 'HeartIcon' },
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-30 lg:hidden">
          ...
          <div className="relative flex flex-col w-full max-w-xs pb-12 overflow-y-auto bg-white shadow-xl">
            ...
            <div className="mt-5 px-2 space-y-1">
              {navigation.map((item) => (
                <Link
                  ...
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <span className="mr-4 h-6 w-6 text-gray-500 group-hover:text-gray-500">
            ...
            <div className="mt-auto pt-4 pb-3 border-t border-gray-200">
              <div className="px-4 flex items-center">
                <div className="flex-shrink-0">
                  <div className="h-10 w-10 rounded-full bg-primary-600 flex items-center justify-center text-white">
                    {userRole === 'vendor' ? 'V' : userRole === 'retailer' ? 'R' : 'A'}
                  </div>
                </div>
                <div className="ml-3">
                  <div className="text-base font-medium text-gray-800">
                    {userRole === 'vendor' ? 'Vendor Account' : userRole === 'retailer' ? 'Retailer Account' : 'Admin Account'}
                  </div>
                  <div className="text-sm font-medium text-gray-500">
                    {userRole === 'vendor' ? 'vendor@example.com' : userRole === 'retailer' ? 'retailer@example.com' : 'admin@example.com'}
                  </div>
                </div>
              </div>
          ...
          <div className="flex-grow mt-5 flex flex-col">
            <nav className="flex-1 px-2 pb-4 space-y-1">
              {navigation.map((item) => (
                ...
                >
                  <span className="mr-3 h-6 w-6 text-gray-500 group-hover:text-gray-500">
                    {renderIcon(item.icon)}
                  </span>
                  {item.name}
                </Link>
